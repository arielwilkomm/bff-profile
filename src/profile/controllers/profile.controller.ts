...
import { ProfileRecordDTO } from '../dto/profile.dto';
...
export default class ProfileController {
  ...
  constructor(@Inject(PROFILE_SERVICE) profileService: ProfileService) {
  ...
  async createProfile(
    ...
    @Res() response: Response<ProfileRecordDTO | ExceptionResponseDTO>,
  ): Promise<void> {
  ...
  async deleteProfile(
    @Param('cpf') cpf: string,
    @Res() response: Response<{ message: string } | ExceptionResponseDTO>,
  ): Promise<void> {
